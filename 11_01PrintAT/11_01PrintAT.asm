...
DisplayScreen
        ...
        lda     Strings
        sta     ZeroTmpMem01   ;store No of string to display in temp location
        lda     #<Strings+1
        ldy     #>Strings+1
        jsr     PrintAt
...
Strings
        ...
        byte    $00,$01,Red                          ;X,Y Position + colour
        byte    $A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0,$A0 ;$0A = Inverse Space
